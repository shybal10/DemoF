...
public class InvoiceConfRecViewAdapter extends RecyclerView.Adapter<InvoiceConfRecViewAdapter.ItemViewHolder> {
    private ViewDetailsGridViewAdapter viewDetailsGridViewAdapter;
    private Context context;
    public InvoiceConfRecViewAdapter(Context context) {
        this.context = context;
    }
    @Override
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.conf_invoice_rec_view_item,parent,false);
        return new InvoiceConfRecViewAdapter.ItemViewHolder(v);
    }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView) {
            super(itemView);
            viewDetails = (LinearLayout) itemView.findViewById(R.id.view_invoice_details_layout);
            closeDetails = (LinearLayout) itemView.findViewById(R.id.close_view_detail_layout);
            viewDetailsGridView = (ViewDetailsGridView) itemView.findViewById(R.id.conf_invoice_view_details_grid_view);
        }
    }
}
