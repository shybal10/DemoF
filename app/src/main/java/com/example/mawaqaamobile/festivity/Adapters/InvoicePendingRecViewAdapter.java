...
public class InvoicePendingRecViewAdapter extends RecyclerView.Adapter<InvoicePendingRecViewAdapter.ItemViewHolder> {
    private Context context;
    private ViewDetailsGridViewAdapter viewDetailsGridViewAdapter;
    public InvoicePendingRecViewAdapter(Context context){
        this.context = context;
    }
    @Override
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.prnding_invoice_rec_view_item,parent,false);
        return new InvoicePendingRecViewAdapter.ItemViewHolder(v);
    }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView) {
            ...
            viewDetailsGridView = (ViewDetailsGridView) itemView.findViewById(R.id.pending_invoice_view_details_grid_view);
        }
    }
}
